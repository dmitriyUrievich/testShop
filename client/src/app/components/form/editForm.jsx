...
const EditForm = () => {
  ...
  const handleChange = useCallback(({ target }) => {
    ...
    console.log([target.name], target.value, 'value11')
  })
  ...
  //   const arrayCategories = Object.values(categorys)
  //   if (categorys) {
  //     for (const categ of arrayCategories) {
  //       if (categ.id === id) {
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(updateProduct({ productId, newData })).then(() => navigate(`/${productId}`))
  }
  const validate = () => {
